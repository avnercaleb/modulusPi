...
const uint8_t AESKey128[] = { 0xFA, 0xE6, 0xDC, 0x39, 0xD4, 0x4C, 0xA5, 0x92, 0x1B, 0xBF, 0x0C, 0x74, 0x07, 0xA5, 0x01, 0xA3} ;
...
void AESECBEncryptBlockStaticKey(uint8_t *data_block, void *session, uint8_t *encrypt_block)
{
	...
	encrypt_block[0] = Sbox[(uint8_t)(t0 >> 24)] ^ (uint8_t)(tt >> 24);
	encrypt_block[1] = Sbox[(uint8_t)(t1 >> 16)] ^ (uint8_t)(tt >> 16);
	encrypt_block[2] = Sbox[(uint8_t)(t2 >>  8)] ^ (uint8_t)(tt >>  8);
	encrypt_block[3] = Sbox[(uint8_t)t3] ^ (uint8_t)tt;

	tt = session_key->key[0][Nr][1];
	encrypt_block[4] = Sbox[(uint8_t)(t1 >> 24)] ^ (uint8_t)(tt >> 24);
	encrypt_block[5] = Sbox[(uint8_t)(t2 >> 16)] ^ (uint8_t)(tt >> 16);
	encrypt_block[6] = Sbox[(uint8_t)(t3 >>  8)] ^ (uint8_t)(tt >>  8);
	encrypt_block[7] = Sbox[(uint8_t)t0] ^ (uint8_t)tt;

	tt = session_key->key[0][Nr][2];
	encrypt_block[8] = Sbox[(uint8_t)(t2 >> 24)] ^ (uint8_t)(tt >> 24);
	encrypt_block[9] = Sbox[(uint8_t)(t3 >> 16)] ^ (uint8_t)(tt >> 16);
	encrypt_block[10] = Sbox[(uint8_t)(t0 >>  8)] ^ (uint8_t)(tt >>  8);
	encrypt_block[11] = Sbox[(uint8_t)t1] ^ (uint8_t)tt;

	tt = session_key->key[0][Nr][3];
	encrypt_block[12] = Sbox[(uint8_t)(t3 >> 24)] ^ (uint8_t)(tt >> 24);
	encrypt_block[13] = Sbox[(uint8_t)(t0 >> 16)] ^ (uint8_t)(tt >> 16);
	encrypt_block[14] = Sbox[(uint8_t)(t1 >>  8)] ^ (uint8_t)(tt >>  8);
	encrypt_block[15] = Sbox[(uint8_t)t2] ^ (uint8_t)tt;
}
...
void AESECBDecryptBlockStaticKey(uint8_t *encrypt_block, void *session, uint8_t *decrypt_block)
{
	uint32_t t0, t1, t2, t3, tt;
	uint32_t a0, a1, a2, a3, r;
    AES_SESSION_KEY *session_key;
	...
	decrypt_block[ 0] = InvSbox[(uint8_t)(t0 >> 24)] ^ (uint8_t)(tt >> 24);
	decrypt_block[ 1] = InvSbox[(uint8_t)(t3 >> 16)] ^ (uint8_t)(tt >> 16);
	decrypt_block[ 2] = InvSbox[(uint8_t)(t2 >>  8)] ^ (uint8_t)(tt >>  8);
	decrypt_block[ 3] = InvSbox[(uint8_t) t1] ^ (uint8_t)tt;

	tt = session_key->key[1][Nr][1];
	decrypt_block[ 4] = InvSbox[(uint8_t)(t1 >> 24)] ^ (uint8_t)(tt >> 24);
	decrypt_block[ 5] = InvSbox[(uint8_t)(t0 >> 16)] ^ (uint8_t)(tt >> 16);
	decrypt_block[ 6] = InvSbox[(uint8_t)(t3 >>  8)] ^ (uint8_t)(tt >>  8);
	decrypt_block[ 7] = InvSbox[(uint8_t) t2] ^ (uint8_t)tt;

	tt = session_key->key[1][Nr][2];
	decrypt_block[ 8] = InvSbox[(uint8_t)(t2 >> 24)] ^ (uint8_t)(tt >> 24);
	decrypt_block[ 9] = InvSbox[(uint8_t)(t1 >> 16)] ^ (uint8_t)(tt >> 16);
	decrypt_block[10] = InvSbox[(uint8_t)(t0 >>  8)] ^ (uint8_t)(tt >>  8);
	decrypt_block[11] = InvSbox[(uint8_t) t3] ^ (uint8_t)tt;

	tt = session_key->key[1][Nr][3];
	decrypt_block[12] = InvSbox[(uint8_t)(t3 >> 24)] ^ (uint8_t)(tt >> 24);
	decrypt_block[13] = InvSbox[(uint8_t)(t2 >> 16)] ^ (uint8_t)(tt >> 16);
	decrypt_block[14] = InvSbox[(uint8_t)(t1 >>  8)] ^ (uint8_t)(tt >>  8);
	decrypt_block[15] = InvSbox[(uint8_t) t0] ^ (uint8_t)tt;
}
#else
...
void AESECBEncryptBlock(uint8_t *plain_text, void *session, uint8_t *cipher_text, AES_KEY_TYPE key_type)
{
	...
	cipher_text[7] = Sbox[(uint8_t)t0] ^ (UINT8)tt;
